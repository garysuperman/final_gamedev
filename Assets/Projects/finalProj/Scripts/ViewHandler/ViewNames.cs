...
public class ViewNames {
	...
	public const string RESULT_SCREEN_NAME = "ResultScreen";
    public const string INSTRUCTIONS_SCREEN_NAME = "InstructionsScreenAesir";
    public const string MAIN_SCREEN_NAME = "MainMenuScreenAesir";
